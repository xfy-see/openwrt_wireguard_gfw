...
Valid options are:
    ...
    -n, --nftset <nftset_name>
                Nftset name for the GfwList domains (format: family#table#set)
...
- gfwlist to dnsmasq rule file without nftset: https://cokebar.github.io/gfwlist2dnsmasq/dnsmasq_gfwlist.conf

- gfwlist to dnsmasq rule file with nftset: https://cokebar.github.io/gfwlist2dnsmasq/dnsmasq_gfwlist_nftset.conf
